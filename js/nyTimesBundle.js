...
/***/ function(module, exports, __webpack_require__) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'h3',
					null,
					'New York Times News (International Edition)'
				),
	...
	ReactDOM.render(React.createElement(NyTimesFeed, { url: 'http://carol5-test.apigee.net/v1/nytimes_intl_news' }), document.getElementById('nytimes'));
